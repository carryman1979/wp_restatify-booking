...
- Added repository-level AGENTS and Copilot instruction files linked to centralized shared guidelines.
- Updated release docs and wiki index for the current maintenance release.
